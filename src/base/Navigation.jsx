...
function Navigation({placeholder, border}) {
  return (
    <li className={`font-theSans h-full w-fit md:px-2 lg:px-5 xl:px-8 2xl:px-10 flex justify-center items-center content-center ${border ? 'border-l border-slate-600' : 'border-none border-opacity-5'}`}>
